...
--
-- Host: 127.0.0.1    Database: dagevolve
-- ------------------------------------------------------
...
--
-- Table structure for table `gameconsoles`
--

DROP TABLE IF EXISTS `gameconsoles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gameconsoles` (
  `Console Name` text COLLATE utf8mb4_unicode_ci,
  `Type` text COLLATE utf8mb4_unicode_ci,
  `Company` text COLLATE utf8mb4_unicode_ci,
  `Released Year` int DEFAULT NULL,
  `Discontinuation Year` int DEFAULT NULL,
  `Units sold (million)` double DEFAULT NULL,
...
-- Dump completed on 2026-03-18 18:57:46
